...
//TODO(mlbileschi): fix lower tone generated by square wave. consider looking at older versions. It's in the conversion to stereo that it get screwed up somehow.
//TODO(mlbileschi): consider rounding to the nearest cent, then only generating one second then copying

public class SoundFactory {

  public static final float MIN_FREQUENCY = 440;
  public static final float MAX_FREQUENCY = 880;
  private static final int SAMPLE_RATE = 8000;

  public static AudioTrack newAudioTrack(int length) {
  ...
  public static void addToAudioTrack(byte[] soundToPlay, AudioTrack audioTrack,
      int offset) {
    audioTrack.write(soundToPlay, offset, soundToPlay.length);
  }
  ...
  public static float[] toWeightedStereo(float[] sample,
    ...
    int toReturnIdx = 0;
    float rightPercentVolume = 1 - leftPercentVolume;
    for (int i = 0; i < sample.length; i++) {
      float d = sample[i];
      toReturn[toReturnIdx++] = d * rightPercentVolume * overallVolume;
